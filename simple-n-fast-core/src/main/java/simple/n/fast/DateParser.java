...
public final class DateParser {
	...
	public static long internalParseISODateToMillis(final String pDate) {
		final int year = (charToInt[pDate.charAt(0)] * 1000) + (charToInt[pDate.charAt(1)] * 100) + (charToInt[pDate.charAt(2)] * 10) + charToInt[pDate.charAt(3)];
		final int month = ((charToInt[pDate.charAt(5)] * 10) + charToInt[pDate.charAt(6)]) - 1;
		final long dateMillis = yearsMillis[year - 1970]
				+ (leapYears.contains(year) ? monthMillisInLeapYear[month] : monthMillis[month])
