...
public class DateFormatterTest {
    ...
    @Test
    public void formatNowDateTest() throws ParseException {
        formatDateTest(DateTime.now().toString(DATE_PATTERN));
    }

    @Test
    public void formatOriginDateTimeTest() throws ParseException {
        formatDateTimeTest("1970-01-01T00:00:00");
    }

    @Test
    public void formatNowDateTimeTest() throws ParseException {
